...
namespace PosTech.Fase1.Contatos.Api.Controllers
{
    ...
    {
        [HttpPost]
        public async Task<ActionResult> Adicionar([FromBody] ContatoRequestDTO contatoRequestRequestDto)
        {
        ...
        [HttpPut]
        public async Task<ActionResult> Atualizar([FromBody] ContatoRequestDTO contatoRequestRequestDto)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<ContatoRequestDTO>>> Listar()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<ContatoRequestDTO>> Obter(int id)
        {
        ...
        public async Task<ActionResult<IEnumerable<ContatoRequestDTO>>> ListarComDDD(int ddd)
        {
